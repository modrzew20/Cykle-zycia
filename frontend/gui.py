...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        MainWindow.setStyleSheet("QDialogButtonBox > QPushButton{\n"
                                 ...
                                 "\n"
                                 "#widget{\n"
                                 "background:url(./frontend/images/logo.svg)\n"
                                 "\n"
                                 "}\n"
                                 "\n"
                                 "QDialogButtonBox > QPushButton:hover{\n"
                                 ...
                                 "{\n"
                                 "    background: url(./frontend/images/tlo2.jpg);\n"
                                 "}\n"
                                 "\n"
                                 "#newrent,#newroom{\n"
                                 "    border-radius: 25px;\n"
                                 ...
                                 "}")
        MainWindow.setWindowIcon(QtGui.QIcon("./frontend/images/logogorne.svg"))
